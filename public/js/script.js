...
var AnimKanpai = function () {
  ...
  _createClass(AnimKanpai, [{
    key: 'initialize',
    value: function initialize() {
      this.$elm = (0, _jquery2.default)(canvas);
...
(function (lib, img, cjs, ss) {
  ...
  lib.properties = {
    ...
    opacity: 1.00,
    webfonts: {},
    manifest: [{ src: "images/kanpai_atlas_.png", id: "kanpai_atlas_" }]
  };

  lib.ssMetadata = [{ name: "kanpai_atlas_", frames: [[0, 0, 348, 382], [0, 384, 347, 382], [64, 768, 92, 40], [158, 768, 30, 71], [0, 768, 62, 61], [97, 810, 41, 41], [49, 831, 46, 41], [0, 831, 47, 44]] }];
